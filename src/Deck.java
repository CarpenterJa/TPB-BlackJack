...
public class Deck {
	...
	public static void addDeck() {
		...
		deck.add(new Deck("Two of Spades", 2, 0.5));
		deck.add(new Deck("Three of Spades", 3, 1));
		deck.add(new Deck("Four of Spades", 4, 1));
		deck.add(new Deck("Five of Spades", 5, 1.5));
		deck.add(new Deck("Six of Spades", 6, 1));
		deck.add(new Deck("Seven of Spades", 7, 0.5));
		deck.add(new Deck("Eight of Spades", 8, 0));
		deck.add(new Deck("Nine of Spades", 9, -0.5));
		...
		deck.add(new Deck("Two of Hearts", 2, 0.5));
		deck.add(new Deck("Three of Hearts", 3, 1));
		deck.add(new Deck("Four of Hearts", 4, 1));
		deck.add(new Deck("Five of Hearts", 5, 1.5));
		deck.add(new Deck("Six of Hearts", 6, 1));
		deck.add(new Deck("Seven of Hearts", 7, 0.5));
		deck.add(new Deck("Eight of Hearts", 8, 0));
		deck.add(new Deck("Nine of Hearts", 9, -0.5));
		...
		deck.add(new Deck("Two of Clubs", 2, 0.5));
		deck.add(new Deck("Three of Clubs", 3, 1));
		deck.add(new Deck("Four of Clubs", 4, 1));
		deck.add(new Deck("Five of Clubs", 5, 1.5));
		deck.add(new Deck("Six of Clubs", 6, 1));
		deck.add(new Deck("Seven of Clubs", 7, 0.5));
		deck.add(new Deck("Eight of Clubs", 8, 0));
		deck.add(new Deck("Nine of Clubs", 9, -0.5));
		...
		deck.add(new Deck("Two of Diamonds", 2, 0.5));
		deck.add(new Deck("Three of Diamonds", 3, 1));
		deck.add(new Deck("Four of Diamonds", 4, 1));
		deck.add(new Deck("Five of Diamonds", 5, 1.5));
		deck.add(new Deck("Six of Diamonds", 6, 1));
		deck.add(new Deck("Seven of Diamonds", 7, 0.5));
		deck.add(new Deck("Eight of Diamonds", 8, 0));
		deck.add(new Deck("Nine of Diamonds", 9, -0.5));
